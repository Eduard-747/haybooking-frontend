    ...
    return (
      <div className="w-[280px] bg-white border-l border-gray-200 flex flex-col h-full font-sans shrink-0 shadow-sm z-20">
        <div className="p-4 border-b border-gray-100 flex items-center gap-2">
          ...
          <h3 className="font-semibold text-gray-800 text-sm">Floor Information</h3>
        </div>
        
        <div className="p-4 space-y-6 flex-1 overflow-y-auto">
          <div>
            <label className="text-xs font-semibold text-gray-500 uppercase tracking-wider mb-2 block">Restaurant</label>
            <div className="text-sm font-medium text-gray-900">{restaurantName}</div>
          </div>
          
          <div>
            <label className="text-xs font-semibold text-gray-500 uppercase tracking-wider mb-2 block">Current Floor</label>
            <div className="text-sm font-medium text-gray-900">{activeFloor?.name || "No Floor Selected"}</div>
          </div>
          
          <div className="grid grid-cols-2 gap-3 pt-4 border-t border-gray-100">
            <div className="bg-gray-50 p-3 rounded-lg border border-gray-100">
              <div className="text-xs text-gray-500 mb-1 flex items-center gap-1.5"><LayoutGrid className="w-3.5 h-3.5" /> Tables</div>
              <div className="text-lg font-bold text-gray-900">{activeTables.length}</div>
            </div>
            <div className="bg-gray-50 p-3 rounded-lg border border-gray-100">
              <div className="text-xs text-gray-500 mb-1 flex items-center gap-1.5"><Users className="w-3.5 h-3.5" /> Seats</div>
              <div className="text-lg font-bold text-gray-900">{totalSeats}</div>
            </div>
          </div>
          
          <div>
            <label className="text-xs font-semibold text-gray-500 uppercase tracking-wider mb-3 block">Status Overview</label>
            <div className="space-y-3">
              <div className="flex items-center justify-between text-sm">
                <div className="flex items-center gap-2"><div className="w-2.5 h-2.5 rounded-full bg-red-500" /> Occupied</div>
                <span className="font-medium">{occupiedTables}</span>
              </div>
              <div className="flex items-center justify-between text-sm">
                <div className="flex items-center gap-2"><div className="w-2.5 h-2.5 rounded-full bg-green-500" /> Available</div>
    ...
    return (
      <div className="w-[280px] bg-white border-l border-gray-200 flex flex-col h-full font-sans shrink-0 shadow-sm z-20">
        <div className="p-4 border-b border-gray-100">
          <h3 className="font-semibold text-gray-800 text-sm">Table Properties</h3>
        </div>
        
        <div className="p-4 space-y-5 flex-1 overflow-y-auto">
          <div className="space-y-2">
            <label className="text-xs font-medium text-gray-600 block">Table Number</label>
            <input 
              type="text" 
          ...
          <div className="grid grid-cols-2 gap-3">
            <div className="space-y-2">
              <label className="text-xs font-medium text-gray-600 block">Capacity</label>
              <input 
                type="number" 
          ...
          <div className="space-y-2">
            <label className="text-xs font-medium text-gray-600 block">Shape</label>
            <select 
              value={table.shape}
          ...
          <div className="pt-4 border-t border-gray-100">
            <label className="text-xs font-semibold text-gray-500 uppercase tracking-wider mb-3 block">Reservation Info</label>
    ...
    <div className="w-[280px] bg-white border-l border-gray-200 flex flex-col h-full font-sans shrink-0 shadow-sm z-20">
      ...
      <div className="p-4 space-y-5 flex-1 overflow-y-auto">
        ...
        <div className="pt-2 border-t border-gray-100">
          <label className="text-xs font-semibold text-gray-500 uppercase tracking-wider mb-3 block">Appearance</label>
      ...
      <div className="p-4 border-t border-gray-100 bg-gray-50 flex flex-col gap-2">
        ...
        >
          {element.locked ? <><Unlock className="w-4 h-4" /> Unlock</> : <><Lock className="w-4 h-4" /> Lock</>}
        </button>
